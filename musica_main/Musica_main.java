...
public class Musica_main {
    ...
    public void reproduzirFaixa(int indice) {
        if (indice >= 0 && indice < faixas.size()) {
            ...
            System.out.println("Índice inválido. Não foi possível reproduzir a faixa.");
        }
    }
    ...
    public void removerFaixa(int indice) {
        if (indice >= 0 && indice < faixas.size()) {
            Faixa removida = faixas.remove(indice);
            System.out.println("Faixa removida: " + removida.getTitulo());
        } else {
            System.out.println("Índice inválido. Nenhuma faixa removida.");
        }
    }
}
